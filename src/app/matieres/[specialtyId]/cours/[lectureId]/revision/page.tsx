...
export default function CoursRevisionPage() {
    ...
    const loadQuestions = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          toast({
            title: "Erreur",
            description: "Échec du chargement des questions",
            variant: "destructive",
          })
        }
      } catch (error) {
  ...
  return (
    <ProtectedRoute>
      <AppSidebarProvider>
        <AppSidebar />
        <SidebarInset className="flex-1 flex flex-col">
          <UniversalHeader title={`Révision - ${lecture?.title || 'Cours'}`} />
          ...
          <div className="flex-1 bg-gray-50 dark:bg-gray-900">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span>/</span>
                <span className="text-gray-900 dark:text-gray-100 font-medium">Révision</span>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      Réviser les questions avec les réponses - {questions.length} questions
                    </p>
                  </div>
                </div>
          ...
          {questions.length === 0 ? (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                Ce cours n'a pas encore de questions. Revenez plus tard pour des mises à jour de contenu.
              </p>
            </div>
          ) : (
